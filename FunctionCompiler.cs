...
namespace Plot3D
{
    ...
    public static class FunctionCompiler
    {
        ...
        public static CompiledFunction Compile(int parametersCount, string functionBody)
        {
            ...
            if (!functionBody.StartsWith("result"))
            {
                functionBody = string.Format("result = {0};", functionBody);
            }
            ...
            functionBody = functionBody.Replace("log2", "(1/Math.Log(2))*Math.Log");
            ...
            strb = strb.Append("double y = x2;\n");
            strb = strb.Append("double z = x3;\n");
            strb = strb.Append("double val = x4;\n");
            strb.Append("double ").Append(functionBody).Append(";");

            string str = string.Format(@"using System;
                                        using {1};  
                                        public class Eval
                                        {{
                                        ...
                                        }}", strb.ToString(), typeof(CompiledFunction).Namespace);
